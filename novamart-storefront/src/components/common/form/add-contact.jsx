...
import { useAddContactMutation } from '@framework/contact/contact';
...
const AddContactForm = ({ lang }) => {
    ...
    const { mutate: addContact, isPending } = useAddContactMutation();
    ...
    return (
        <div className="w-full md:w-[510px] mx-auto p-5 sm:p-8 bg-brand-light rounded-md">
            ...
            <form onSubmit={handleSubmit(onSubmit)} noValidate>
                ...
                <Button className="h-11 md:h-12 w-full mt-1.5" type="submit" loading={isPending} disabled={isPending}>
