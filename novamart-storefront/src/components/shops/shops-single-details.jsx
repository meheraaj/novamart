...
export default function ShopsSingleDetails({ lang }) {
  const { t } = useTranslation(lang, 'common');
  const pathname = useParams();
  const { slug } = pathname;
  const { data, isLoading } = useShopQuery(slug);
  ...
  return (
    <>
      ...
      <Container>
        ...
        >
          <div className="shrink-0 hidden lg:block lg:w-80 xl:w-87.5 2xl:w-96 lg:sticky lg:top-20 category-mobile-sidebar">
