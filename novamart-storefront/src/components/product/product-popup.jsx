...
export default function ProductPopup({ lang }) {
  ...
  return (
    <div className="md:w-150 lg:w-235 xl:w-295 2xl:w-340 mx-auto p-1 lg:p-0 xl:p-3 bg-brand-light rounded-md">
      ...
      <div className="overflow-hidden">
        <div className="px-4 pt-4 md:px-6 lg:p-8 2xl:p-10 mb-9 lg:mb-2 md:pt-7 2xl:pt-10">
          <div className="items-start justify-between lg:flex">
            ...
            <div className="shrink-0 flex flex-col lg:ltr:pl-5 lg:rtl:pr-5 xl:ltr:pl-8 xl:rtl:pr-8 2xl:ltr:pl-10 2xl:rtl:pr-10 lg:w-107.5 xl:w-117.5 2xl:w-120">
              <div className="pb-5">
                <div
              ...
              {tag && (
                <ul className="pt-5 xl:pt-6">
                  ...
                  {tag?.map((item) => (
                    <li className="inline-block p-0.75" key={`tag-${item.id}`}>
                      <TagLabel data={item} />
                    </li>
                  ))}
                </ul>
