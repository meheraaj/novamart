...
export default function ProductDetailsTab({ lang }) {
      ...
      <TabGroup>
        ...
        <TabPanels className="mt-6 lg:mt-9">
          <TabPanel className="lg:flex">
            ...
            <div className="shrink-0 lg:w-100 xl:w-120 2xl:w-137.5 3xl:w-[680px] lg:ltr:pl-10 lg:rtl:pr-10 xl:ltr:pl-14 xl:rtl:pr-14 2xl:ltr:pl-20 2xl:rtl:pr-20 pt-5 lg:pt-0">
              <Heading
