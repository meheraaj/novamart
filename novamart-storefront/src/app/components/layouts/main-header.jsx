...
function Header({ lang }) {
    ...
    return (
        <header
            ...
            ref={siteHeaderRef}
            className={cn(
                'header-one w-full h-16 lg:h-20 z-40 sticky top-0',
        ...
        >
            <div className="z-20 w-full h-16 transition duration-200 ease-in-out shadow-header innerSticky body-font bg-brand-light lg:h-20">
                <Search
                    className={cn(
                        'top-bar-search lg:max-w-[600px] absolute z-30 px-4 md:px-6 top-1 lg:hidden',
                        displayMobileSearch ? 'flex' : 'hidden',
                    )}
                    lang={lang}
                />
                ...
                <Container className="flex items-center justify-between w-full h-full">
                    <div className="flex shrink-0">
                        <button
                            aria-label="Menu"
                            className="flex-col items-center justify-center flex lg:hidden outline-none menuBtn ltr:mr-5 rtl:ml-5 shrink-0 focus:outline-none"
                    ...
                    <HeaderMenu
                        ...
                        className="hidden w-auto ltr:pl-10 rtl:pr-10 lg:flex"
                        lang={lang}
                    />
                    <Search
                    ...
                    <div className="flex shrink-0 -mx-2.5 xl:-mx-3.5">
                        ...
                        <div className="items-center hidden lg:flex shrink-0 xl:mx-3.5 mx-2.5">
                            ...
                            >
                                {userData?.name || userData?.email || t('text-account')}
                            </AuthMenu>
                        </div>
                    </div>
                </Container>
